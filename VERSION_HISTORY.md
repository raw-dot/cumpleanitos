...
| **0.16.0** | 10-Apr-2026 | — | Feature: Agenda de cumpleaños + Organización colaborativa de regalos | 3 tablas nuevas (friends, birthday_events, birthday_organizers). 3 páginas nuevas: FriendsPage (onboarding juego + swipe cards + botón + FAB), BirthdayEventPage (stepper 3 pasos: info/organizadores múltiples/regalo), BirthdayEventDetailPage (vista cumpleañero decisión/aprobación, vista regalador con estados verified/surprise/pending/rejected). App.jsx: pageParams state, navigate() extendido, PAGE_ROUTES nuevas, 3 cases en renderPage, BottomNav con pestaña Amigos. | ✅ OK | "implementemoslo en test y que funcione, que sea funcional" |
